...
function clearSession(){
	setCookie("player1WinCount",  "",  0);
	setCookie("player2WinCount",  "",  0);
}

function onLoad() {
  gui = new GameGui();
  if(getCookie("player1WinCount") == null || getCookie("player1WinCount").length == 0){
	  player1WinCount = 0;
	  player2WinCount = 0;
  }
  else{	  
	  player1WinCount = parseInt(getCookie("player1WinCount"));
	  player2WinCount = parseInt(getCookie("player2WinCount"));
  }
